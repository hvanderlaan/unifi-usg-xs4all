...
```
+---------------------------+
|   XS4ALL FTTJ internet    |
+---------------------------+
            |
           WAN
+---------------------------+
|  usg.core.brakkedoos.nl   |
...
+---------------------------+
          LAN
            ...
            1
+---------------------------+       +---------------------------+       +---------------------------+
|  sw01.core.brakkedoos.nl  |       |  ap01.core.brakkedoos.nl  |       |  ap01.core.brakkedoos.nl  |
|  unifi switch 8 60w PoE   |       | Unifi AC Lite accesspoint |       | Unifi AC Lite accesspoint |
+---------------------------+       +---------------------------+       +---------------------------+
   2  3  4     5  6  7  8                       |  PoE                               | PoE
   |  |  |     |  |  |  +-----------------------+                                    |
   |  |  |     |  |  +---------------------------------------------------------------+
   |  |  |     |  +------------------------------------------------------------------+
   |  |  |     +--------------------------------+                                    |
      |  |                                      1 PoE                                1 PoE
      |  |                          +---------------------------+       +---------------------------+
      |  |                          | swfm01.core.brakkedoos.nl |       | swfm02.core.brakkedoos.nl |
      |  |                          | Unifi Flex Mini 5port     |       | Unifi Flex Mini 5ports    |
      |  |                          +---------------------------+       +---------------------------+
      |  |                                  2  3  4  5                          2  3  4  5
      |  |                                  |  |  |  |                          |  |  |  |
      |  +--------------+                      |  |  +---------+                      |  |
      ...
      |                 |                 |           |        |             |             |
+----------+  +------------------+  +------------+  +----+   +-----+    +----------+  +----------+
| Apple TV |  | Ikea Smartlights |  | NAS/Docker |  | DNS |  | git |    | Mediabox |  | Mediabox |
+----------+  +------------------+  +------------+  +----+   +-----+    +----------+  +----------+
```
